...
export const GoatService: GoatServiceType = {
  ...
  getForSale: () => ipcRenderer.invoke('goat:getForSale'),
  setForSale: (forSale) => ipcRenderer.invoke('goat:setForSale', forSale),
  onForSaleChange: (callback) => ipcRenderer.on('goat:forSaleChange', (_event, forSale) => callback(forSale)),
